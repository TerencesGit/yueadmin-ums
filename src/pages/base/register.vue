      ...
      <main class="login-main">
        <div class="container">
          <el-form 
            ...
            <h2 class="form-title">悦.欢迎注册</h2>
            <el-form-item label="邮箱号" prop="email">
              <el-input v-model.string="loginForm.email" :autofocus="true" placeholder="请输入邮箱号"></el-input>
            </el-form-item>
            <el-form-item label="密 码" prop="passwd">
              <el-input type="password" v-model="loginForm.passwd" :autofocus="true" placeholder="请输入密码"></el-input>
            </el-form-item>
            <el-form-item label="确认密码" prop="confirmPass">
              <el-input type="password" v-model="loginForm.confirmPass" :autofocus="true" placeholder="再次输入密码"></el-input>
            </el-form-item>
            <el-form-item label="验证码" prop="authcode" :autofocus="true" class="authcode">
              <el-input type="text" v-model="loginForm.authcode" placeholder="请输入验证码"></el-input>
              <canvas id="canvasCode" width="80px" height="30px" class="canvas-code" @click="drawCode"></canvas>
            </el-form-item>
            <el-form-item prop="agreement" label-width="0" class="agreement">
              <el-checkbox-group v-model="loginForm.agreement">
                <el-checkbox name="agreement" label="我已阅读并同意" v-model="checked"></el-checkbox>
                <span class="show" @click="dialogVisible = true">《用户注册协议》</span>
              </el-checkbox-group>
            </el-form-item>
    ...
    methods: {
        ...
        this.$refs.loginForm.validate((valid) => {
          if (valid && !this.logging) {
            ...
            let data = {
              ...
              passwd:  this.$Md5.hex_md5(this.loginForm.passwd),
              passwd2: this.$Md5.hex_md5(this.loginForm.confirmPass),
            }
      ...
      loginSubmit() {
        let data = {
          ...
          password: this.$Md5.hex_md5(this.loginForm.passwd),
        }
